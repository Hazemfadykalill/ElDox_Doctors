...
import { ProfilePatientComponent } from '../../PatAndDocCom/profile-patient/profile-patient.component';
import { PatientsService } from 'src/app/core/services/patients.service';
import { HomeService } from 'src/app/core/services/home.service';

@Component({
  selector: 'app-nav-bar-patient',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './nav-bar-patient.component.html',
  styleUrls: ['./nav-bar-patient.component.scss']
})
export class NavBarPatientComponent {
  ...
  profilePatients(){
    const dialogPopup = new DialogInitializer(ProfilePatientComponent);
